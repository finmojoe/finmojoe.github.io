					...
					for(var a=0;a<jsonData.length;a++){
						...
						// 	group.innerHTML+="<p>"+data[a].name+"</p>";
							...
							table_body.innerHTML+="<tr id='row0"+itemId+"'><td><p class='item-name-p'>"+itemName+"</p><p class='item-desc-p'><span id='desc0"+itemId+"'>"+itemDesc+"</span></p></td>\
										   			   <td><div> <input id='radio0"+itemId+"' class='radio' type='radio' name='size"+itemId+"' onmouseover='checkButton(this,"+price10+","+itemId+")'></div> </td>\
										               <td> <input id='radio0"+itemId+"' class='radio' type='radio' name='size"+itemId+"' onmouseover='checkButton(this,"+price14+","+itemId+")'> </td>\
										               <td> <input id='radio0"+itemId+"' class='radio' type='radio' name='size"+itemId+"' onmouseover='checkButton(this,"+price18+","+itemId+")'> </td>\
